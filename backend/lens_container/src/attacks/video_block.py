...
rtsp_filter_layer_instance = tcp_layer.TCPFilterLayer(8554)
...
rtsp_lbf_layer_instance.register_child(rtsp_layer_instance)

video_filter_layer_instance = udp_layer.UDPFilterLayer(8000)
...
ffmpeg_layer_instance = video_layer.FfmpegLayer("sh", "video_block.sh",log="ffmpeg.log")
recorder_layer_instance.register_child(ffmpeg_layer_instance)
